  ...
  */  
  ...
  public String getName() {
    if (GeneName_Type.featOkTst && ((GeneName_Type)jcasType).casFeat_name == null)
      jcasType.jcas.throwFeatMissing("name", "services.uima.types.GeneName");
  ...
  public int getAnnotatorId() {
    if (GeneName_Type.featOkTst && ((GeneName_Type)jcasType).casFeat_annotatorId == null)
      jcasType.jcas.throwFeatMissing("annotatorId", "services.uima.types.GeneName");
    return jcasType.ll_cas.ll_getIntValue(addr, ((GeneName_Type)jcasType).casFeatCode_annotatorId);}
  ...
  public void setAnnotatorId(int v) {
    if (GeneName_Type.featOkTst && ((GeneName_Type)jcasType).casFeat_annotatorId == null)
      jcasType.jcas.throwFeatMissing("annotatorId", "services.uima.types.GeneName");
    jcasType.ll_cas.ll_setIntValue(addr, ((GeneName_Type)jcasType).casFeatCode_annotatorId, v);}    
  }
