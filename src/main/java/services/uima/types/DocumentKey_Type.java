...
public class DocumentKey_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("services.uima.types.DocumentKey");
  ...
  public String getKey(int addr) {
      ...
      jcas.throwFeatMissing("key", "services.uima.types.DocumentKey");
